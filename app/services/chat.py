...
class ChatService:
    def __init__(self, chart_service: ChartService, openai_service: OpenAIService):
    ...
    @classmethod
    async def get_service(cls, chart_service: ChartService = Depends(ChartService.get_service), openai_service: OpenAIService = Depends(OpenAIService.get_service)):
        return cls(chart_service, openai_service)
